...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Add validate all feeds button
  const validateAllBtn = document.createElement("button");
  validateAllBtn.textContent = "Validate All Feeds";
  validateAllBtn.className = "btn";
  validateAllBtn.style.marginLeft = "8px";
  validateAllBtn.addEventListener("click", validateAllFeeds);
  document.getElementById("addFeedBtn").parentNode.appendChild(validateAllBtn);
